# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 19:27:18 2016
...
plt.plot(x_e,y_e,color='blue',label='Earth')
plt.plot(x_j,y_j,color='orange',label='Jupiter')
...
plt.ylabel('y/AU')
#ylim(-6,6)
plt.savefig('three-body trajectory5.png')
plt.show()
#3D plot
fig = figure()
...
ax.set_ylabel('y/AU')
ax.set_zlabel('t/yr')
savefig('three-body trajectory5 3D.png')
show()